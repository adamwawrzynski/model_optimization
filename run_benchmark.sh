...
for BATCH_SIZE in "1" "16" "32" "64"; do
    ...
    poetry run python3 benchmark.py --type cuda --use_fp16 --batch_size $BATCH_SIZE --n_runs $N_RUNS --model_name $MODEL_NAME
    poetry run python3 benchmark.py --type cuda --use_jit --batch_size $BATCH_SIZE --n_runs $N_RUNS --model_name $MODEL_NAME
    poetry run python3 benchmark.py --type cuda --use_fp16 --use_jit --batch_size $BATCH_SIZE --n_runs $N_RUNS --model_name $MODEL_NAME
    poetry run python3 benchmark.py --type tensorrt --batch_size $BATCH_SIZE --n_runs $N_RUNS --model_name $MODEL_NAME
    poetry run python3 benchmark.py --type tensorrt --use_fp16 --batch_size $BATCH_SIZE --n_runs $N_RUNS --model_name $MODEL_NAME
    poetry run python3 benchmark.py --type tensorrt --use_jit --batch_size $BATCH_SIZE --n_runs $N_RUNS --model_name $MODEL_NAME
    poetry run python3 benchmark.py --type tensorrt --use_use_fp16fp --use_jit --batch_size $BATCH_SIZE --n_runs $N_RUNS --model_name $MODEL_NAME
